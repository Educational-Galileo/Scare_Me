/*
 ...
 Analog Input: light sensor, sound sensor 
...
void setup() {  
  ...
  lightThresholdValue=analogRead(lightSensorPin);
  lightThresholdValue=lightThresholdValue-50;
  if (debug==1){
    Serial.print(lightThresholdValue);
    Serial.println(" lightThresholdValue\n");
  }
//  soundThresholdValue=analogRead(soundPin);
//  soundThresholdValue=soundThresholdValue+50;
  soundThresholdValue=200;
  if (debug==1){
    Serial.print(soundThresholdValue);
    Serial.println(" soundThresholdValue\n");
  }
  lcd.begin(16, 2);
  lcd.print(" Scare me!");
  delay(2000);
...
*/
      ...
      if (soundValue > soundThresholdValue || photoResistorValue < lightThresholdValue){ //blink led if its dark
